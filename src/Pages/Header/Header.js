                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav>
                            ...
                            {   user?
                                <Nav.Link as={Link} to="publisher">All Supplier</Nav.Link> : ''
                            ...
                            {
                                user ?
                                    <button className='btn btn-link text-primary text-decoration-none' onClick={handleSignOut}>Log out</button>
                                    :
